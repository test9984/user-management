...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Vivek Kumar Mishra", "www.birlasoft.com",
			"vivek.mishra3@birlasoft.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Thirdeye API Documentation", "Api Documentation", "1.0",
